...
public final class OverscrollHelper {
	...
	/**
	 * Helper method for Overscrolling that encapsulates all of the necessary function. This
	 * version of the call is used for Views that need to specify a Scroll Range but scroll back to
	 * it's edge correctly.
	 * 
	 * @param view
	 *            - PullToRefreshView that is calling this.
