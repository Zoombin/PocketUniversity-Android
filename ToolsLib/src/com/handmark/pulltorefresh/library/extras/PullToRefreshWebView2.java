 ...
 * <code>isReadyForPullUp()</code>, it is your job to calculate whether the view is in a state
 * where a PullToRefresh can happen, and return the result via the callback mechanism. An example
 * can be seen below:
 * <p/>
 * 
 * <pre>
