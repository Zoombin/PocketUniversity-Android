...
public interface IPullToRefresh<T extends View> {
	 ...
	 * will only use touch events where the difference in the Y-axis is greater than the difference
	 * in the X-axis. This means that the View will not interfere when it is used in a horizontal
	...
	/**
	 * Get whether the 'Refreshing' View should be automatically shown when refreshing. Returns
	 * true by default.
	 * 
	 ...
	 * touch events where the difference in the Y-axis is greater than the difference in the
	 * X-axis. This means that the View will not interfere when it is used in a horizontal
	 * scrolling View (such as a ViewPager), but will restrict which types of finger scrolls will
	 * trigger the View.
	 * 
	 * @param filterEvents
