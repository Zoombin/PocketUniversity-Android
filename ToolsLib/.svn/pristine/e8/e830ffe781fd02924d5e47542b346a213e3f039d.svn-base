...
public class JSONUtils {
	...
	public static <T> T fromJson(String json, TypeToken<T> token, String datePattern) {
		...
		try {
			...
			VolleyLog.e(ex, "%s 无法转换为 %s 对象!", json, token.getRawType().getName());
			return null;
		}
	}
	...
	public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
		...
		try {
			...
			VolleyLog.e(ex, "%s 无法转换为 %s 对象!", json, clazz.getName());
			return null;
		}
	}
	...
	public static <T> T fromJson(JsonElement jsonElement, Class<T> clazz) {
		...
		try {
			...
			VolleyLog.e(ex, "%s 无法转换为 %s 对象!", jsonElement.toString(), clazz.getName());
			return null;
		}
	}
	...
	public static String toJson(Object target, Type targetType, GsonBuilder builder) {
		...
		try {
			...
			VolleyLog.e(ex, "目标对象 %s 转换 JSON 字符串时，发生异常！", target.getClass().getName());
